        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-xl">
              Εσωτερικός Κανονισμός Λειτουργίας & Όροι Χρήσης
            </CardTitle>
          </CardHeader>
          <CardContent className="prose prose-sm max-w-none text-sm space-y-4">
            <p>
